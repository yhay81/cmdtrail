...
CmdTrail v0.1.0 uses the `portable_pre_post_snapshot` backend on Linux, macOS,
and Windows. It is useful for controlled project directories, but it is not a
sandbox or complete tracer.

| Capability | v0.1.0 coverage | Why |
| --- | --- | --- |
...
| Network and listening ports | Unavailable | No socket instrumentation in v0.1.0 |
| Resource totals | Unavailable | No portable per-tree accounting in v0.1.0 |
...
gh attestation verify \
  cmdtrail-v0.1.0-macos-aarch64.tar.gz \
